function [x,y,z,savepts] = mfwdtran(ax,varargin)
...
[mstruct, lat, lon, alt, objectType] = parseInputs(ax,varargin{:});
[x, y, z, savepts] = feval( ...
    mstruct.mapprojection, mstruct, lat, lon, alt, objectType, 'forward');

%-----------------------------------------------------------------------

function [mstruct, lat, lon, alt, objectType] = parseInputs(ax,varargin)
