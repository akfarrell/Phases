...
intensity(1:end) = 0.2;
c= WindRose(az,intensity,'nspeeds',2,'colors',[0.6 0.6 0.6; 0.6 0.6 0.6],'titlestring','','labels',deg_labels,'ndirections',20,'freqlabelangle',45);
...
d = WindRose(az2,intensity,'nspeeds',2,'colors',[0.6 0.6 0.6; 0.6 0.6 0.6],'titlestring','','labels',deg_labels,'ndirections',20,'freqlabelangle',45);
%set(gca,'LineWidth',1,'Color',[0 0 0])
