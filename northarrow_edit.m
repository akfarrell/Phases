function hout = northarrow(ax,varargin)
...
switch s.action
    ...
    case 'mouseup'
        ...
        [lat,lon] = minvtran(xOrigin,yOrigin);
...
% Set the ZData to the current maximum for elements of the arrow
ch = get(ax,'Children');
maxZ = NaN(size(ch));
for i = 1:numel(ch)
